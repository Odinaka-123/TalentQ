...
const history: HistoryEntry[] = [
  {
    freelancer: "Cloudscale Technologies",
    role: "React Developer",
    date: "Jun 2025",
    rating: 5,
    review:
      "Exceptional employer. Clear brief, prompt payment, and great communication throughout.",
  },
  {
    freelancer: "PocketFund",
    role: "UX Consultant",
    date: "Apr 2025",
    rating: 5,
    review:
      "Deep understanding of the product space. Highly recommended for fintech projects.",
  },
  {
    freelancer: "Kola Health",
    role: "Data Engineer",
    date: "Feb 2025",
    rating: 4.8,
    review: "Great team to work with. Clean requirements and fast approvals.",
  },
];
