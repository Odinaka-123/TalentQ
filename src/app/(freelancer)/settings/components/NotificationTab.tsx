    ...
    <div className="flex flex-col gap-6">
      <div className="rounded-2xl border border-[#E5E0D6] bg-white px-6 py-6">
        <h3 className="text-base font-semibold text-[#1F2A22]">
          {t("app_freelancer_settings_components_notification_tab.in_app_notifications")}</h3>
        <p className="text-xs text-[#8A8A7E] mb-2">
          {t("app_freelancer_settings_components_notification_tab.choose_what_appears_in_your_notification")}</p>
      ...
      <div className="rounded-2xl border border-[#E5E0D6] bg-white px-6 py-6">
        <h3 className="text-base font-semibold text-[#1F2A22]">
          {t("app_freelancer_settings_components_notification_tab.email_notifications")}</h3>
        <p className="text-xs text-[#8A8A7E] mb-2">
      ...
      <div className="rounded-2xl border border-[#E5E0D6] bg-white px-6 py-6">
        <h3 className="text-base font-semibold text-[#1F2A22] mb-2">{t("app_freelancer_settings_components_notification_tab.sound")}</h3>
